    ...
    <div className="space-y-8">
      ...
      <section className="space-y-3">
        ...
        {gates && winner ? (
          ...
          <div className="surface rounded-lg p-4 md:p-5 space-y-2">
            <p className="text-[12px] text-secondary leading-relaxed max-w-[80ch]">
              Regime check paused. Could not fetch Nifty prices right now. Try
              again after your morning Kite login, or a bit later once the price
              source frees up.
            </p>
            {bt.regimeGate.note && (
              <details className="text-[11px] text-tertiary">
                ...
                <p className="mt-1 leading-relaxed max-w-[80ch] mono-true">
                  {bt.regimeGate.note}
                </p>
              </details>
            )}

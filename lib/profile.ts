...
import { ROLE_ORDER, ROLE_TARGET, type Role } from "./roles";
...
export function defaultProfile(): Profile {
  return {
    ...
    limits: {
      // Rule 3: one cap, % of TOTAL book, for every direct stock (IN and US).
      singleNameCapPct: CONCENTRATION.singleStockPctOfBook,
      usSingleNameCapPct: CONCENTRATION.singleStockPctOfBook,

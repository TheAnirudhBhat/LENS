...
export const HoldingSchema = z.object({
  ...
  // Rule 5: the written sell condition, stamped when written/re-underwritten.
  exitIf: z.string().optional(),
  exitIfAt: z.string().optional(),
...
export const DecisionSchema = z.object({
  ...
  note: z.string().optional(),
  // Rule 10: every decision cites a rule slug; BUYs carry the thesis + exit condition (rule 5).

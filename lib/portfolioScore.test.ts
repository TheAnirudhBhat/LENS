...
function balancedBook(): ScoreInput {
  ...
  return {
    ...
    positions: [
      // Every stock under the 6%-of-total single-stock cap (top = 55k = 5.5%).
      ...
      // US names all ≤4.5% of total book.
...
describe("computePortfolioScore", () => {
  ...
  it("penalises an over-concentrated, under-ballasted book and surfaces the right levers", () => {
    ...
    const input: ScoreInput = {
      ...
      positions: [
        // One US name = 24.5% of the total book → breaches the 6% cap hard.
        ...
        // One IN name = 30% of the total book → breaches the 6% cap.
  ...
  it("flags an over-cap named cluster against the total book while no single stock breaches", () => {
    const total = 1_000_000;
    const input: ScoreInput = {
      asOf: "2026-06-15T00:00:00.000Z",
      total,
      ...
      positions: [
        // Rule 3 is measured against the TOTAL book (1m): every stock stays
        // under the 6% single-stock cap (<60k) while the named cluster
        // CHIP + CHIP2 + GENAI = 150k = 15% breaches the 12% cluster cap.
        { ticker: "CHIP", market: "US", role: "growth", valueINR: 55_000 },
        { ticker: "CHIP2", market: "US", role: "growth", valueINR: 55_000 },
        { ticker: "USX", market: "US", role: "compounders", valueINR: 58_000 },
        { ticker: "USY", market: "US", role: "compounders", valueINR: 56_000 },
        { ticker: "USZ", market: "US", role: "compounders", valueINR: 56_000 },
        { ticker: "USW", market: "US", role: "compounders", valueINR: 35_000 },
        { ticker: "USV", market: "US", role: "compounders", valueINR: 35_000 },
        { ticker: "GENAI", market: "IN", role: "growth", valueINR: 40_000 },
      ...
      rules: {
        ...DEFAULT_RULES,
        size: { ...DEFAULT_RULES.size, clusters: { "ai-infra": ["CHIP", "CHIP2", "GENAI"] } },
      },
      mfSchemes: [
